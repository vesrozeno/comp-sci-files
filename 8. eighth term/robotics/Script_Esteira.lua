...
function sysCall_thread()
    ...
    place4=sim.getObject('/conveyor/place4')
    ...
    dropToPlace(place4, 0, dropHeight3, pickup3, true)
    ...
    pickupBoxFromPlace(greenBox1, pickup3)
    dropToPlace(place4, 0, dropHeight3, pickup3, true)
    pickupBoxFromPlace(greenBox2, pickup3)
    dropToPlace(place4, 0, dropHeight3, pickup3, true)
    pickupBoxFromPlace(greenBox3, pickup3)
    dropToPlace(place4, 0, dropHeight3, pickup3, true)
